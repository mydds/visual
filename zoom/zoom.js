...
function getImageTags(index) {
  ...
  if (
    ...
    index === 89 || index === 99 || index === 101 || index === 102 || index === 103 || index === 82 || index === 85 || index === 86 || index === 61 || index === 45
  ) {
    return "Project X,";
  }
  if (
